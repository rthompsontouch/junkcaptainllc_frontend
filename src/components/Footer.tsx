        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-4">
              <a
                ...
                className="w-10 h-10 bg-white/10 hover:bg-orange rounded-full flex items-center justify-center transition-colors"
                aria-label="Facebook"
              >
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="#pricing" className="text-gray-300 hover:text-orange transition-colors">
                  Pricing
                </Link>
              </li>
              <li>
